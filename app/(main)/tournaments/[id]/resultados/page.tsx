  ...
  return (
    <div className="min-h-full bg-background/70">
      <header className="border-b border-border/70 bg-card/90 px-4 py-4 backdrop-blur sm:px-6">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-3 flex items-start gap-3">
            <div className="rounded-elevated bg-primary/10 p-2.5 text-primary"><Table2 className="h-5 w-5" /></div>
      ...
      <main className="mx-auto max-w-7xl p-4 sm:p-6">
        <div className="mb-5 rounded-elevated border border-primary/15 bg-primary/5 p-4 text-sm text-slate-700">
