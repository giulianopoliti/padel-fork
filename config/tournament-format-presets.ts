...
export const TOURNAMENT_FORMAT_PRESETS: Record<OperationalTournamentFormatPresetId, TournamentFormatConfigV2> = {
  ...
  AMERICAN_MULTI_ZONE_HYBRID_2: {
    ...
    rankingScope: 'PER_ZONE',
    rankingPolicyId: 'STANDARD_PADEL',
    qualificationSource: 'HYBRID_FIRSTS_GLOBAL_REST_ZONES',
    bracketSeedingStrategy: 'HYBRID_FIRSTS_GLOBAL_REST_ZONES',
    zoneRules: {
      minSize: 3,
      maxSize: 5,
      idealSize: 4,
    ...
    display: {
      name: 'Americano multizona hibrido',
      description: 'Ordena los primeros por tabla general y completa la llave con segundos, terceros y demas por serpenteo de zonas.',
    },
  },
  ...
  AMERICAN_SINGLE_ZONE_GLOBAL_2: {
    version: 2,
    presetId: 'AMERICAN_SINGLE_ZONE_GLOBAL_2',
    baseType: 'AMERICAN',
    zoneMode: 'SINGLE_ZONE',
    zoneStage: 'FIXED_MATCH_COUNT',
    targetMatchesPerCouple: 2,
    bracketMode: 'SINGLE',
    advancementConfig: { kind: 'SINGLE', advanceCount: 64, allocationMode: 'AUTO' },
    rankingScope: 'GLOBAL', rankingPolicyId: 'STANDARD_PADEL',
    qualificationSource: 'GLOBAL_STANDINGS', bracketSeedingStrategy: 'GLOBAL_RANKING',
    zoneRules: { minSize: 3, maxSize: 32, idealSize: 8, allowedSizes: Array.from({ length: 30 }, (_, index) => index + 3) },
    display: { name: 'Americano zona única + llave', description: 'Zona General con 2 partidos por pareja y llave por tabla general.' },
  },
  AMERICAN_SINGLE_ZONE_GLOBAL_3: {
    version: 2,
    presetId: 'AMERICAN_SINGLE_ZONE_GLOBAL_3',
    baseType: 'AMERICAN', zoneMode: 'SINGLE_ZONE', zoneStage: 'FIXED_MATCH_COUNT', targetMatchesPerCouple: 3,
    bracketMode: 'SINGLE', advancementConfig: { kind: 'SINGLE', advanceCount: 64, allocationMode: 'AUTO' },
    rankingScope: 'GLOBAL', rankingPolicyId: 'STANDARD_PADEL', qualificationSource: 'GLOBAL_STANDINGS', bracketSeedingStrategy: 'GLOBAL_RANKING',
    zoneRules: { minSize: 3, maxSize: 32, idealSize: 8, allowedSizes: Array.from({ length: 30 }, (_, index) => index + 3) },
    display: { name: 'Americano zona única + llave', description: 'Zona General con 3 partidos por pareja y llave por tabla general.' },
  },
  AMERICAN_SINGLE_ZONE_GLOBAL_GOLD_SILVER_2: {
    version: 2,
    presetId: 'AMERICAN_SINGLE_ZONE_GLOBAL_GOLD_SILVER_2',
    baseType: 'AMERICAN', zoneMode: 'SINGLE_ZONE', zoneStage: 'FIXED_MATCH_COUNT', targetMatchesPerCouple: 2,
    bracketMode: 'GOLD_SILVER', advancementConfig: { kind: 'GOLD_SILVER', goldCount: 4, silverCount: 4, eliminatedCount: 0, allocationMode: 'AUTO' },
    rankingScope: 'GLOBAL', rankingPolicyId: 'STANDARD_PADEL', qualificationSource: 'GLOBAL_STANDINGS', bracketSeedingStrategy: 'GLOBAL_RANKING',
    zoneRules: { minSize: 3, maxSize: 32, idealSize: 8, allowedSizes: Array.from({ length: 30 }, (_, index) => index + 3) },
    display: { name: 'Americano zona única (Oro y Plata)', description: 'Zona General con 2 partidos por pareja y copas desde la tabla general.' },
  },
  AMERICAN_SINGLE_ZONE_GLOBAL_GOLD_SILVER_3: {
    version: 2,
    presetId: 'AMERICAN_SINGLE_ZONE_GLOBAL_GOLD_SILVER_3',
    baseType: 'AMERICAN', zoneMode: 'SINGLE_ZONE', zoneStage: 'FIXED_MATCH_COUNT', targetMatchesPerCouple: 3,
    bracketMode: 'GOLD_SILVER', advancementConfig: { kind: 'GOLD_SILVER', goldCount: 4, silverCount: 4, eliminatedCount: 0, allocationMode: 'AUTO' },
    rankingScope: 'GLOBAL', rankingPolicyId: 'STANDARD_PADEL', qualificationSource: 'GLOBAL_STANDINGS', bracketSeedingStrategy: 'GLOBAL_RANKING',
    zoneRules: { minSize: 3, maxSize: 32, idealSize: 8, allowedSizes: Array.from({ length: 30 }, (_, index) => index + 3) },
    display: { name: 'Americano zona única (Oro y Plata)', description: 'Zona General con 3 partidos por pareja y copas desde la tabla general.' },
  },
...
const LEGACY_PRESET_REDIRECTS: Record<Exclude<TournamentFormatPresetId, OperationalTournamentFormatPresetId>, OperationalTournamentFormatPresetId> = {
  ...
  AMERICAN_SINGLE_ZONE_2_BRACKET: 'AMERICAN_SINGLE_ZONE_GLOBAL_2',
  AMERICAN_SINGLE_ZONE_3_BRACKET: 'AMERICAN_SINGLE_ZONE_GLOBAL_3',
