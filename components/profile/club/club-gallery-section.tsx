...
export function ClubGallerySection({ defaultValues, onSaveChanges, isSaving }: ClubGallerySectionProps) {
  ...
  return (
    <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
              {galleryImages.map((imageUrl, index) => (
                <div key={index} className="relative group overflow-hidden rounded-surface border border-gray-200 shadow-sm">
                  ...
                  />
                  <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center p-2 md:p-3">
                    <Button
                      type="button"
                      size="sm"
                      variant="destructive"
      ...
      {onSaveChanges && (
        <div className="bg-gray-50 rounded-surface border border-gray-200 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="bg-gray-100 w-8 h-8 rounded-surface flex items-center justify-center">
